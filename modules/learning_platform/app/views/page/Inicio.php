        ...
        <div class="courses-row">
          ...
          <div class="course-card">
            <div class="course-image">
              <img src="https://deingenieriaindustrial.com/wp-content/uploads/2024/01/image-54-740x675.png" alt="Curso">
              <span class="level beginner">Principiante</span>
            </div>

            <div class="course-body">
              <h4>HTML & CSS Moderno</h4>
              <p>Construye sitios web atractivos desde cero.</p>
          ...
          <div class="course-card">
            <div class="course-image">
              <img src="https://deingenieriaindustrial.com/wp-content/uploads/2024/01/image-54-740x675.png" alt="Curso">
              <span class="level intermediate">Intermedio</span>
            </div>

            <div class="course-body">
              <h4>JavaScript Esencial</h4>
              <p>Domina JS y crea aplicaciones dinámicas.</p>
          ...
          <div class="course-card">
            <div class="course-image">
              <img src="https://deingenieriaindustrial.com/wp-content/uploads/2024/01/image-54-740x675.png" alt="Curso">
              <span class="level advanced">Avanzado</span>
            </div>

            <div class="course-body">
              <h4>React desde Cero</h4>
              <p>Componentes, hooks y buenas prácticas.</p>
          ...
          <div class="course-card">
            ...
            <div class="course-body">
              <h4>UI/UX para Developers</h4>
              <p>Diseña interfaces claras y usables.</p>
          ...
          <div class="course-card">
            ...
            <div class="course-body">
              <h4>Backend con Node.js</h4>
              <p>APIs, autenticación y bases de datos.</p>
